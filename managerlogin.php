...
<html lang="en">
      ...
      <div class="man_log">
          <div class="row">
              <div class="col-sm-offset-1 col-sm-10 contactForm" >
                  <h1>MANAGER LOGIN!</h1>
                  <br/>
                  <form name="f1" action = "managerAUTH.php" onsubmit = "return validation()" method="post">
                  <div class="form-grop">
                      <div class="form-grop">
                      ...
                      <input  name="manager_ID" id="manager_ID" placeholder="manager_ID" class="form-control" maxlength="50">
                      </div>
  ...
  <script>  
            ...
            {  
                ...
                var ps=document.f1.manager_ID.value;  
